...
SEC("socket")
__log_level(2)
/* Callee only writes fp[0]-8 (no read): parent_live backward pass
 * determines slot is NOT live at entry (write kills it), stack_use=0.
 * No stack liveness columns printed when all zero.
 */
__msg("2: .12345.... (85) call pc+1")
...
__msg("4: {{.*}} 0000000000000000:0000000000000003 (85) call pc+")
...
SEC("socket")
__log_level(2)
__msg("4: {{.*}} 0000000000000000:00000000000000cc (85) call pc+5 // stack_use=0:c")
__msg("7: {{.*}} 0000000000000000:00000000000000c0 (85) call pc+2 // stack_use=0:c0")
...
__msg("6: {{.*}} 0000000000000000:00000000000000c0 (85) call pc+")
...
__msg("3: {{.*}} 0000000000000000:0000000000000003 (85) call pc+")
__msg("7: {{.*}} 0000000000000000:0000000000000003 (85) call pc+")
...
SEC("socket")
__log_level(2)
__msg("9: {{.*}} 0000000000000000:000000000000000c (85) call bpf_loop#181 // stack_use=0:c")
...
SEC("socket")
__log_level(2)
__msg("14: (7b) *(u64 *)(r6 -8) = r7 // nonlocal_def[0]=0:c")
__msg("15: (79) r0 = *(u64 *)(r6 -8) // nonlocal_use[0]=0:c")
__msg("9: .1234..... (85) call bpf_loop")
...
SEC("socket")
__log_level(2)
__msg("8: {{.*0033}} (85) call bpf_loop{{.*}}stack_use=0:3")
__msg("15: {{.*0030}} (85) call bpf_loop{{.*}}stack_use=0:30")
...
__log_level(2)
__success
__msg("14: (79) r1 = *(u64 *)(r10 -8) // stack_use=0:3 r6=fp0-8 r7=fp1-16 fp-8=fp1-16 fp-16=fp0-8")
__msg("15: (79) r0 = *(u64 *)(r1 +0) // stack_use=0:c r1=fp1-16 r6=fp0-8 r7=fp1-16 fp-8=fp1-16 fp-16=fp0-8")
...
__log_level(2)
__success
__msg("13: (79) r1 = *(u64 *)(r10 -8) // stack_use=0:3 r6=fp0-8 r7=fp1-16 fp-8=fp1-16 fp-16=fp0-8")
__msg("14: (79) r0 = *(u64 *)(r1 +0) // stack_use=0:c r1=fp1-16 r6=fp0-8 r7=fp1-16 fp-8=fp1-16 fp-16=fp0-8")
...
__log_level(2)
__success
__msg("call bpf_snprintf")
__msg("stack_use=ffffffffffffffff:ffffffffffffffff")
__msg("nonlocal_use[0]=0:3")
...
__msg("17: (79) r0 = *(u64 *)(r1 +0) // nonlocal_use[2]=0:c r1=fp0-16")
__msg("14: (85) call pc+2	r1: fp0-8")
__msg("17: (79) r0 = *(u64 *)(r1 +0) // nonlocal_use[2]=0:3 r1=fp0-8")
__msg("5: {{.*}} 0000000000000000:000000000000000f (85) call pc+5 // stack_use=0:f")
...
__log_level(2)
__success
__msg("call bpf_loop#181 // stack_use=ffffffffffffffff:ffffffffffffffff")
