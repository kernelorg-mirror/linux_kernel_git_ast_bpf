...
static struct bpf_test tests[] = {
	...
	},
	{
		...
		.fixup_map2 = { 3 },
		.errstr = "R0 value is outside of the array range",
		.result = REJECT,
		.flags = F_NEEDS_EFFICIENT_UNALIGNED_ACCESS,
	},
	{
	...
	},
	{
		...
		.fixup_map2 = { 3 },
		.errstr = "R1 value is outside of the array range",
		.result = REJECT,
		.prog_type = BPF_PROG_TYPE_TRACEPOINT,
	},
	{
	...
	},
	{
		...
		.fixup_map2 = { 3 },
		.errstr = "invalid access to map value, value_size=48 off=1008",
		.result = REJECT,
		.flags = F_NEEDS_EFFICIENT_UNALIGNED_ACCESS,
	},
	{
	...
	},
	{
		...
		.fixup_map1 = { 3 },
		.errstr = "invalid access to map value, value_size=8 off=255 size=1",
		.result = REJECT,
	},
	{
