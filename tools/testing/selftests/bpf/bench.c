...
extern struct argp bench_qp_trie_lookup_argp;
...
static const struct argp_child bench_parsers[] = {
	...
	{ &bench_qp_trie_lookup_argp, 0, "QP-trie lookup benchmark", 0 },
...
extern const struct bench bench_bpf_qp_trie_lookup;
